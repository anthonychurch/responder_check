 ...
 */
public class WinRfs_runDBcheckUI_5 extends javax.swing.JFrame {

    /** Creates new form WinRfs_runDBcheckUI_5 */
    public WinRfs_runDBcheckUI_5() {
        initComponents();
    }
    ...
    private static void checkmembers() throws Exception{
		...
		try {
			if(rs.next()){
				...
				SMS_ipipi_utilitities ipipi = new SMS_ipipi_utilitities(ipipiUsrName,ipipiPassword);
				//String[] response = ipipi.sendMessage(responderCheckSMSOUT, checkMessage);
				//if(response == null){
				//for(String r : response){
				//	log = logMacro("ADVICE", r, tss, log, printLogs);
				//}
    	...
    	ActionListener upDateClock = new ActionListener() {
        	public void actionPerformed(ActionEvent evt) {
        		if(runProgram == true){
        			...
        			String hr = TimeStamp_Utilities.getTShours(tss);
        			String mn = TimeStamp_Utilities.getTSminutes(tss);
...
//}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinRfs_runDBcheckUI_5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new WinRfs_runDBcheckUI_5().setVisible(true);
                runCheck();
